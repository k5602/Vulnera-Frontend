...
(function () {
    ...
    window.VulneraRuntimeConfig = {
        ...
        setConfig: function (config) {
            ...
            var debug =
                window.VULNERA_ENABLE_DEBUG === "true" || (config && config.enableDebug === true);
            if (debug) {
        ...
        autoDetectConfig: function () {
            ...
            if (hostname === "localhost" || hostname === "127.0.0.1") {
                ...
                config = {
                    apiBaseUrl:
                        protocol + "//" + hostname.replace(/^(staging|dev)\.?/, "") + ":3000",
    ...
    if (window.VULNERA_ENABLE_DEBUG === "true") {
        ...
        console.log(
            '   Usage: VulneraRuntimeConfig.setConfig({apiBaseUrl: "https://api.example.com"})',
        );
